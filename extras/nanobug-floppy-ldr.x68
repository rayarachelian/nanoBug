...
*; along with some extra "library" code.  It is incompatible with the normal
...
LASTADDR        DC.L #$00022000            ; last loaded address
LASTSECT        DC.L #$00000000            ; last loaded sector

DC.B            'nanoBug Disk loader - A Part of the Lisa Emulator Project. Copyright (C) 2006, All Rights Reserved. '
DC.B            'Released under the terms of the GNU Public License 2.0',00

;* Need filler here until 22000.
